...
const DockLabel: FC<DockLabelProps> = ({
    children,
    className = '',
    isHovered
}) => {
...
const Dock: FC<DockProps> = ({
    ...
    return (
        <motion.div style={{ height, scrollbarWidth: 'none' }} className="absolute bottom-0 mx-2 flex max-w-full items-center">
            <motion.div
                onMouseMove={({ pageX }) => {
                    isHovered.set(1);
                    mouseX.set(pageX);
